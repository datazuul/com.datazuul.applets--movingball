 ...
 * @see http://www.javacooperation.gmxhome.de/EinfuegenvonBildernEng.html
 */
public class MovingBallPicture extends Applet implements Runnable {
  ...
  public void init() {
    ...
    // Laden der Bilddatei
    backImage = getImage(getCodeBase(), "landscape.jpg");
  }
