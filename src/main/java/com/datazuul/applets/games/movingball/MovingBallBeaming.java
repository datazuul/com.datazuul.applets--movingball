 ...
 * @see http://www.java-tutorial.net/BallStopEng.html
 * @see http://www.javacooperation.gmxhome.de/BallStopEng.html
 */
public class MovingBallBeaming extends Applet implements Runnable {
