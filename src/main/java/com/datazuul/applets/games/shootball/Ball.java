...
public class Ball {
  ...
  /**
   * Diese Klasse enthält alle Funktionen, die f�r die Bewegung, Konstruktion, Positionsbestimmung, Graphik und
  ...
  /**
   * Methode wird nach einem Treffer des Balls aufgerufen, dabei wird x und y übergeben um Ball an die Ausgangsposition
   * zurückzusetzen
   */
   ...
   * berechnet. Hierbei wird zunächst der Abstandsvektor zwischen Ball und Mausereigniss und dann seine Länge bestimmt.
   * Ist diese kleiner als 15, dann gilt der Ball als getroffen und true wid als Argument übergeben. Ansonsten ist der
