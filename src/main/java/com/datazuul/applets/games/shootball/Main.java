...
/**
 * Diese Klasse enthält alle für die Implementierung eines Applets wichtigen Methoden (init, start, stop), desweiteren
 * die Methoden run (zur Implementierung des Interfaces Run- abble), sowie die Graphikmethoden paint und update. Die
 * Klasse realisiert die Dopppel- pufferung in der Methode update, sie hört auf Mausereignisse (mouseDown) und enthält
...
public class Main extends Applet implements Runnable {
  ...
  public boolean mouseDown(Event e, int x, int y) {
	...
	// Ball auf Startwert zurücksetzen
	redball.ballWasHit();
      }
